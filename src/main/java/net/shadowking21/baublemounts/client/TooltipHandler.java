...
public class TooltipHandler {
    ...
    public static class TooltipRender {
        ...
        public TooltipRender(BaubleMountsTooltipComponent component, ResourceLocation location) {
        ...
        public Vector2 calculateSize(List<ClientTooltipComponent> list) {
            ...
            for (ClientTooltipComponent clientTooltipComponent : list) {
                if (clientTooltipComponent.getWidth(Minecraft.getInstance().font) > x)
                    x = clientTooltipComponent.getWidth(Minecraft.getInstance().font);
                y += clientTooltipComponent.getHeight();
            }
            return new Vector2(x, y);
        }

        public static Vector2d getEntitySize(Entity livingEntity, double scale) {
        ...
        public void renderImage(Font font, int x, int y, GuiGraphics guiGraphics) {
            ...
            if (component.entity != null && location.equals(new ResourceLocation("baublemounts:textures/tooltip/button.png"))) {
                vector2d = getEntitySize(component.entity, 0.85);
            ...
            TextureRenderHelper.renderSlicedTexture(guiGraphics, location, x, y, tooltipSize.x, tooltipSize.y, 10, 64, 64);
